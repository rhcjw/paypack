...
Or download [paypack-0.1.0.difypkg](https://github.com/rhcjw/paypack/releases/tag/v0.1.0) and upload locally. | 或下载直接上传。
...
- **Dify Plugin | Dify 插件**: [v0.1.0](https://github.com/rhcjw/paypack/releases/tag/v0.1.0) — pay/query/refund tools
...
|----------|-------|--------|-------------|--------------|
| **Dify** | 100K+ | 数十万 | ✅ [PayPack Plugin](https://github.com/rhcjw/paypack/releases/tag/v0.1.0) |
